...
export const HeroWidget = () => {
  ...
  return (
    <motion.div
      className="border-neutral-6 bg-neutral-5 flex w-fit flex-row gap-4 rounded-md border bg-opacity-20 bg-clip-padding p-5 backdrop-blur-xl backdrop-filter"
