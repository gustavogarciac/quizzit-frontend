...
export const AppCard = () => {
  return (
    <div className="from-accents-1 via-accents-2 to-accents-6 relative z-10 mx-auto flex min-h-[12rem] w-full flex-col items-center justify-center rounded-3xl bg-gradient-to-r p-px">
